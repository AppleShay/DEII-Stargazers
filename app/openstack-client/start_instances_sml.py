...
instance_dev = nova.servers.create(name="G2dev_server_sml", image=image, flavor=flavor, key_name='Group2Project',userdata=userdata_prod, nics=nics,security_groups=secgroups)
